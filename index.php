...
echo "<br>", "<br>";
$sloupecYokubjonAskarov = 17;
$radekYokubjonAskarov = 11;

echo "<table border=\"1\"";
for ($i = 0; $i <= $radekYokubjonAskarov; $i++) {
    echo "<tr>";
    for ($j = 0; $j <= $sloupecYokubjonAskarov; $j++) {
        echo "<td>" . $i . "-" . $j . "</td>";

    }
}

echo "Toto je absolutni hodnota cisla -26 => " . abs(-26) . "<br>";
echo "Tady je odmocnina z cisla 68" . sqrt(68) . "<br> <br>";

$ucwords = "ucwards() meni prvni pismeno u kazdeho slova na velke <br>";
$ucwordsV = ucwords($ucwords);
echo $ucwordsV;
$strrchr = "#Hleda vyskyt |znaku| v retezci! <br> <br>";
$strrchrV = strrchr($strrchr, "#");
echo $strrchrV;

$sizeof = array("obleceni", "technologie", "predmety");
echo "Toto cislo nam rika kolik poli ma promenna \$sizeof &nbsp; => " . sizeof($sizeof) . "<br>";
$pos = array('mobil', 'notebook', 'televize');
$posV = pos($pos);
echo $posV;
echo "<br>", "<br>";

function vyska(float $vyska, string $jednotka)
{
    return "Ja merim " . $vyska . " " . $jednotka;
}
